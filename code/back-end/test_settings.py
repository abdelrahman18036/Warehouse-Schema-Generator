"""
Django settings for testing the warehouse_generator project.
"""
...
ROOT_URLCONF = 'warehouse_generator.urls'
...
WSGI_APPLICATION = 'warehouse_generator.wsgi.application'
...
# Custom User Model
AUTH_USER_MODEL = 'schema_generator.User'
